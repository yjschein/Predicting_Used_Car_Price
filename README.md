...
## Data Cleaning
The data cleaning phase was a lot of work due to the high number of missing and strange values. This often occurs on websites where anyone can edit and post anything. In this case it was very messy because anyone can go on craigslist and post their car and often there were absurd prices in the millions of dollars for cars that would normally only be worth a couple thousand dollars. 
